    ...
    <form>
      ...
      <div>
        ...
        <FormControl>
          ...
          <Input id="sickLeaveStart" type="text" name="sickLeaveStart" value={sickLeaveStart} onChange={(e) => setSickLeaveStart(e.target.value)}/>
        </FormControl>
        <FormControl>
          <InputLabel htmlFor="sickLeaveEnd" required>end</InputLabel>
          <Input id="sickLeaveEnd" type="text" name="sickLeaveEnd" value={sickLeaveEnd} onChange={(e) => setSickLeaveEnd(e.target.value)}/>
        </FormControl>
      </div>
    </form>
  );
